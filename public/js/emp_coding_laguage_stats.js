...
let programmingLanguagePreference;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    .then(([languageData, accuracyData]) => {
        ...
        programmingLanguagePreference = true;
    ...
    .catch((error)=>{
        ...
        programmingLanguagePreference = false;
        defaultValues(programmingLanguagePreference);
    });
});



//DEfault fucntion should execute when data not found or some error occurs
function defaultValues(){
    // Default when error occurs
    ...
    renderLanguageCards(combinedData, backgroundColors);
    renderCodingLangChart(combinedData, backgroundColors);
