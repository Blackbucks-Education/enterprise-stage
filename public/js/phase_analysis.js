...
// Initial display setup
document.addEventListener('DOMContentLoaded', () => {
const defaultSection = document.getElementById('Absentees-List'); // Ensure this matches your default section ID
if (defaultSection) {
...
// Initial display setup
document.addEventListener('DOMContentLoaded', () => {
const defaultSection = document.getElementById('sattendance-inactive-download'); // Ensure this ID matches your default section
if (defaultSection) {
  defaultSection.classList.add('active');
} else {
