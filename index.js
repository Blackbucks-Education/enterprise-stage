...
// Apply authentication middleware to all routes except those listed in bypassPaths
const bypassPaths = [
  "/login",
  "/error",
  "/auth/google",
...
nextApp.prepare().then(() => {
  ...
  app.all("/compareAssessments", (req, res) => handle(req, res));
  app.all("/employbilityMonthlyReport", (req, res) => handle(req, res));
  app.all("/employabilityStudentsResults", (req, res) => handle(req, res));
  app.all("/employabilityReport", (req, res) => handle(req, res));
  app.all("/assessmentStudentResults",(req, res) => handle(req, res));
  app.all("/internshipsDashboard", (req, res) => handle(req, res));
  app.all("/internshipReport", (req, res) => handle(req, res));
  app.all("/myDashboard", (req, res) => handle(req, res));
  app.all("/_next/*", (req, res) => handle(req, res));
  app.all("/_next", (req, res) => handle(req, res));
  app.all("/internshipDomain", (req, res) => handle(req, res));
